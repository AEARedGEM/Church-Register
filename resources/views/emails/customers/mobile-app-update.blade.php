...
@section('content')
    ...
    <table class="info-table" style="width: 100%; max-width: 500px; margin: 20px 0; border-collapse: collapse;">
        <tr>
            <td class="label" style="padding: 12px 15px; border-bottom: 1px solid #000000; font-weight: 600; color: #000000; width: 35%;">Version</td>
            <td style="padding: 12px 15px; border-bottom: 1px solid #000000;">{{ $version }}</td>
        </tr>
        <tr>
            <td class="label" style="padding: 12px 15px; border-bottom: 1px solid #000000; font-weight: 600; color: #000000; width: 35%;">Release Date</td>
            <td style="padding: 12px 15px; border-bottom: 1px solid #000000;">{{ $release_date }}</td>
        </tr>
        <tr>
            <td class="label" style="padding: 12px 15px; border-bottom: 1px solid #000000; font-weight: 600; color: #000000; width: 35%;">Size</td>
            <td style="padding: 12px 15px; border-bottom: 1px solid #000000;">{{ $size }}</td>
        </tr>
    </table>

    <div style="text-align: center; margin: 30px 0;">
        <a href="{{ $update_url }}" class="button" style="display: inline-block; padding: 12px 25px; background-color: #10b981; color: #ffffff !important; text-decoration: none; border-radius: 4px; font-weight: 600; margin: 15px 0;">
            Update Now
        </a>
    </div>
    <div style="background-color: #ffffff; border-left: 4px solid #10b981; padding: 15px; margin: 20px 0;">
        <h3 style="margin-top: 0; color: #10b981;">Important Notes</h3>
        <ul style="margin-bottom: 0; padding-left: 20px;">
