                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
                  ...
                  <div className="relative w-full sm:w-64 lg:w-80">
                    ...
                    <input
                      ...
                      className="block w-full pl-9 sm:pl-10 pr-3 py-2 sm:py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg leading-5 bg-white dark:bg-gray-700 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm dark:text-white"
                    />
                  </div>
                  ...
                  <div className="flex gap-2 sm:gap-3">
                    ...
                    >
                      ...
                      {hasActiveFilters && (
                        <span className="bg-white text-red-600 text-xs px-2 py-0.5 rounded-full font-semibold">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-red-600 text-white hover:bg-red-700 transition-colors font-medium whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                    >
                    ...
                    <button
                      onClick={() => router.visit(route('users.create'))}
                      className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-red-600 text-white hover:bg-red-700 transition-colors font-medium whitespace-nowrap text-sm shadow-sm hover:shadow-md"
                    >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 sm:p-12 min-h-[400px] flex items-center justify-center">
              <div className="text-center max-w-md">
                ...
                <button
                  ...
                  className="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-sm sm:text-base font-medium"
                >
                  Clear Filters
                </button>
              </div>
