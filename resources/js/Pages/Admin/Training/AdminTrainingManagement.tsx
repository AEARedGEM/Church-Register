    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <div className="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        <input
          ...
          className="px-4 py-2 rounded-lg border border-gray-300 bg-white text-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
        />
        <select
          value={filter.status}
              ...
              <div className={`p-4 bg-white dark:bg-gray-800 flex items-center gap-3`}>
                ...
                <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-3">
                  <input
                    ...
                    className={`px-3 py-2 rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none`}
                  />
                  <input
                    type="text"
              ...
              {expandedSection === sectionIndex && (
                <div className={`p-4 border-t border-gray-200 dark:border-gray-700 space-y-3`}>
                  ...
                  <button
                    ...
                    className="w-full py-2 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors flex items-center justify-center gap-2"
                  >
                    <Plus size={18} />
                    Add Lecture
                  </button>
