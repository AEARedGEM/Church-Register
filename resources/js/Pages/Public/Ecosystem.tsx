        ...
        <>
            ...
            <div className="min-h-screen bg-white dark:bg-gray-900">
                ...
                <div className="container mx-auto px-6 py-16 max-w-4xl">
                    ...
                    <div className="bg-gradient-to-r from-red-50 to-red-50 dark:from-red-950 dark:to-red-950 rounded-lg p-8">
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Explore More</h3>
                        <div className="flex gap-4 flex-wrap">
                            <Link href="/program" className="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors">
                                Program Overview
                            </Link>
                            <Link href="/impact" className="px-6 py-2 border border-red-600 text-red-600 dark:text-red-400 rounded-lg hover:bg-red-50 dark:hover:bg-red-950 transition-colors">
                                See Our Impact
                            </Link>
                        </div>
                    </div>
