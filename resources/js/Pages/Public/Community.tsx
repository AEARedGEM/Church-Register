                ...
                <div className="container mx-auto px-6 py-16 max-w-5xl">
                    ...
                    <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr]">
                        ...
                        <aside className="space-y-6 rounded-3xl border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-950">
                            <div>
                                <p className="text-xs uppercase tracking-[0.25em] text-emerald-500">Community First</p>
                            ...
                            <div className="rounded-3xl border border-emerald-200 bg-emerald-50 p-5 dark:border-emerald-700 dark:bg-emerald-950/60">
                                <p className="text-sm uppercase tracking-[0.2em] text-emerald-700 dark:text-emerald-300">Join the movement</p>
                            ...
                            <Link href="/funding" className="inline-block w-full rounded-xl bg-emerald-600 px-5 py-3 text-center text-sm font-semibold text-white hover:bg-emerald-700 transition-colors">Explore Funding & Tokenization</Link>
