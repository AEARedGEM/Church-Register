                ...
                <div className="container mx-auto px-6 py-16 max-w-4xl">
                    ...
                    <div className="mt-12 bg-gradient-to-r from-red-50 to-red-50 dark:from-red-950 dark:to-red-950 rounded-lg p-8 text-center">
                        ...
                        <div className="flex gap-4 justify-center flex-wrap">
                            <Link href="/leadership" className="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors">
                                Meet Our Leadership
                            </Link>
                            <Link href="/governance" className="px-6 py-2 border border-red-600 text-red-600 dark:text-red-400 rounded-lg hover:bg-red-50 dark:hover:bg-red-950 transition-colors">
