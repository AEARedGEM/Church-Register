...
export default function Terms() {
    return (
        <>
            <Head title="Terms of Service - NYP-IP" />
                ...
                <div className="container mx-auto px-6 py-16 max-w-4xl">
                    ...
                    <div className="prose prose-lg dark:prose-invert max-w-none space-y-6 text-gray-700 dark:text-gray-300">
                        <section>
                            ...
                            <p>By accessing and using the NYP-IP platform, you agree to comply with these Terms of Service. If you do not agree with any part, please do not use our services.</p>
                        </section>
                        <section>
                        ...
                        <section>
                            ...
                            <p>Participation in NYP-IP programs is subject to specific terms, conditions, and eligibility requirements. All participants must comply with program guidelines and regulations.</p>
                        </section>
                        <section>
