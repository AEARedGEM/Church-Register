                    ...
                    <div className="grid gap-6 xl:grid-cols-[1.3fr_0.7fr]">
                        <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                            <div className="space-y-6">
                                ...
                                {submitted ? (
                                    <div className="rounded-3xl border border-red-200 bg-red-50 p-6 text-slate-900 dark:border-red-800 dark:bg-red-950 dark:text-white">
                        ...
                        <aside className="space-y-6">
                            <div className="rounded-3xl border border-red-200 bg-red-50 p-6 shadow-sm dark:border-red-800 dark:bg-red-950">
                                <h3 className="text-xl font-semibold text-red-900 dark:text-red-100">Why this matters</h3>
