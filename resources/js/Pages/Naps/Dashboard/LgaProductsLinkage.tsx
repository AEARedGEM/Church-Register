            ...
            {!selectedState && (
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg border border-blue-200 dark:border-blue-800">
                        <p className="text-blue-600 dark:text-blue-400 text-sm font-medium">Total LGAs</p>
                        <p className="text-3xl font-bold text-blue-700 dark:text-blue-300">{lgaProducts.length}</p>
                    </div>
