    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="mx-auto max-w-[1500px] px-4 py-8 sm:px-6 lg:px-8">
                ...
                <p className="mt-4 text-xs text-slate-500">Attendance changes are saved against the actual Sunday date. Use the main attendance board for absent or excused corrections.</p>
            </div>
        </AuthenticatedLayout>
    );
}
