  ...
  return (
    ...
    >
      ...
      <div className="p-4 space-y-4">
        {/* Course Info */}
        <div>
          <h3 className="font-semibold text-gray-900 dark:text-white mb-2 hover:text-red-600 dark:hover:text-red-400 transition-colors">
            {course.title}
          </h3>
        ...
        {variant === 'enrolled' && course.progress > 0 && (
          <ProgressBar
            ...
            showLabel
            color={course.progress === 100 ? 'red' : 'red'}
          />
        )}
